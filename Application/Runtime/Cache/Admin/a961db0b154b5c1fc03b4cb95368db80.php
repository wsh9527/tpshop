            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="navbar navbar-default">
                        <form id="search-form2" class="navbar-form form-inline"  method="post" action="/index.php/Admin/Distribut/remittance">
                            <div class="form-group">
                                <label for="input-order-id" class="control-label">用户ID:</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" id="user_id" placeholder="用户id" value="1" name="user_id" />
                                </div>
                                ...
                                <div class="input-group margin">
                                    ...
                                    <input type="text" id="start_time" value="2015/08/04-2016/08/05" name="create_time" class="form-control pull-right">
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover">
                                ...
                                <!--循环start-->
                                    <tr>
                                        <td class="text-left">
                                            <a href="/index.php/Admin/Distribut/editWithdrawals/id/1">1</a>
                                        </td>
                                        <td class="text-left">
                                            <a href="/index.php/Admin/user/detail/id/1">
                                                1                                        </a>
                                        </td>
                                        <td class="text-left">支付宝</td>
                                        <td class="text-left">5464646@qq.com</td>
                                        <td class="text-left">黄女士</td>
                                        <td class="text-left">100.00</td>
                                        <td class="text-left">支付成功</td>
                                        <td class="text-left">2016-06-20 18:53</td>
                                        <td class="text-left">测试通过</td>
                                        <!--<td class="text-left"><a href="/index.php/Admin/Distribut/editWithdrawals/id/1">查看</a></td>-->
                                    </tr>
                                <!--循环end-->
                                </tbody>
                            </table>
