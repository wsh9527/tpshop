<?php
//000000000000s:131900:"<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
  ...
  <div id="path-new" class="clearfix colaaa text13">
    <div class="item fl">
      ...
      <div class="fl" id="m-selected-cery">
        ...
        <!--如果当前分类是三级分类 则二级也要显示-->
                <!--当前分类-->
        <div class="u-nav-attr"> <a href="javascript:;">办公设备<i></i></a>
          <span class="z-blank-bar"></span>
          <ul class="u-attr-list">
            <li><a href="/index.php/Home/Goods/goodsList/id/24.html">网络产品</a></li><li><a href="/index.php/Home/Goods/goodsList/id/25.html">办公设备</a></li><li><a href="/index.php/Home/Goods/goodsList/id/26.html">文具耗材</a></li><li><a href="/index.php/Home/Goods/goodsList/id/27.html">电脑整机</a></li><li><a href="/index.php/Home/Goods/goodsList/id/28.html">电脑配件</a></li><li><a href="/index.php/Home/Goods/goodsList/id/29.html">外设产品</a></li><li><a href="/index.php/Home/Goods/goodsList/id/30.html">游戏设备</a></li>          </ul>
        </div>
      </div>
    </div>
    <div class="u-left-icon"><i class="z-arrow"></i></div>
        ...
        <ul class="menu_3">
          <li class="menu_two">
            ...
            <span name="submenuicon" class="menuminus"></span>
                          <a  href="/index.php/Home/Goods/goodsList/id/25.html" class="menu3_title">办公设备</a>
            <div class="second_div">
            <span class="second_span"></span>
            <ul 
            style="display: block;"
  ...
  <div class="searchbox">
    <div class="list clearfix">
      <ul class="left text12" id="order_ul">
        ...
        <li> <a class="col7ac  main" href="/index.php/Home/Goods/goodsList/id/25" style="cursor:pointer;"> 默认 </a> </li>
        <li> <a class="col7ac  " href="/index.php/Home/Goods/goodsList/id/25/sort/sales_sum" style="cursor:pointer;"> 销量 </a> </li>
                
                	<li><a class="col7ac  " href="/index.php/Home/Goods/goodsList/id/25/sort/shop_price/sort_asc/desc" style="cursor:pointer;">价格<span class="icon_s "></span></a></li>    
                
        <li><a class="col7ac  " href="/index.php/Home/Goods/goodsList/id/25/sort/comment_count" style="cursor:pointer;">评论</a></li>
        <li><a class="col7ac  "  href="/index.php/Home/Goods/goodsList/id/25/sort/is_new" style="cursor:pointer;">新品</a></li>
      </ul>
      <!-- Page -->
      <div class="right text12" id="pagenavi">
        ...
        <p class="pageArea" data-countPage="1"> 
          ...
          /
          <span class="page_count fontT">0</span>
